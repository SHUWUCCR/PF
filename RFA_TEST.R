...
setwd("/glade2/h2/uwis0026/test_R/RFA_code_with_sample/")
MainPath <- '/glade2/h2/uwis0026/test_R/RFA_code_with_sample/'
...
DataPath <- paste0(MainPath,'Stn_AMS_flagfixed_wMDPR_combined/')
...
sta.d <- read_csv(paste0(MainPath,'COOP_USW_forAMS_wcollar_AKW_d.csv')) # This station list name refer to the station list name in the AMS R code
